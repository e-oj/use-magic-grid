...
var o = (t, e) => Ye(t, "name", { value: e, configurable: !0 }), fe = /* @__PURE__ */ ((t) => typeof require < "u" ? require : typeof Proxy <
"u" ? new Proxy(t, {
...
var zt = b(($l, Ht) => {
  var Vt = Ze(), jt = Object.prototype, _a = jt.hasOwnProperty, Ta = jt.toString, pe = Vt ? Vt.toStringTag : void 0;
  function La(t) {
    var e = _a.call(t, pe), r = t[pe];
    try {
      t[pe] = void 0;
      var n = !0;
    } catch {
    ...
    var a = Ta.call(t);
    return n && (e ? t[pe] = r : delete t[pe]), a;
  }
  o(La, "getRawTag");
  Ht.exports = La;
});
...
var ur = b((sr, et) => {
  (function(t) {
    ...
    return (/* @__PURE__ */ o(function n(a, i, l) {
      ...
      o(u, "s");
      for (var s = typeof fe == "function" && fe, p = 0; p < l.length; p++) u(l[p]);
      return u;
    }, "e"))({ 1: [function(n, a, i) {
...
var K = b((ys, qr) => {
  ...
  }, ye = Ae(), Re = Mr(), Po = ye.call(Function.call, Array.prototype.concat), Oo = ye.call(Function.apply, Array.prototype.splice), Cr = ye.
  call(Function.call, String.prototype.replace), Ne = ye.call(Function.call, String.prototype.slice), xo = ye.call(Function.call, RegExp.prototype.
...
on" && Set.prototype, ut = Object.getOwnPropertyDescriptor && gt ? Object.getOwnPropertyDescriptor(Set.prototype, "size") : null, $e = gt &&
  ...
  de = Wo ? WeakMap.prototype.has : null, Bo = typeof WeakSet == "function" && WeakSet.prototype, me = Bo ? WeakSet.prototype.has : null, Uo = typeof WeakRef ==
  ...
  Dn.exports = /* @__PURE__ */ o(function t(e, r, n, a) {
    ...
    function f(M, $, W) {
      if ($ && (a = Qo.call(a), a.push($)), W) {
        ...
        return B(i, "quoteStyle") && (ce.quoteStyle = i.quoteStyle), t(M, ce, n + 1, a);
      }
      return t(M, i, n + 1, a);
    }
    ...
    if (Rn(e)) {
      ...
      return typeof e == "object" && !ae ? he(m) : m;
    }
    if (ui(e)) {
...
var Vn = b((Cs, Un) => {
  "use strict";
  var qn = Mn(), We = Ot(), ve = qe(), Ci = Object.prototype.hasOwnProperty, Wn = {
    ...
    ki.apply(t, q(e) ? e : [e]);
  }, "pushToArray"), qi = Date.prototype.toISOString, kn = ve.default, R = {
    addQueryPrefix: !1,
    allowDots: !1,
    allowEmptyArrays: !1,
    arrayFormat: "indices",
    ...
    if (i && q(g) && g.length === 0)
      return M + "[]";
    for (var $ = 0; $ < D.length; ++$) {
      var W = D[$], ce = typeof W == "object" && typeof W.value < "u" ? W.value : g[W];
      if (!(u && ce === null)) {
    ...
    if (typeof e.format < "u") {
      if (!Ci.call(ve.formatters, e.format))
        throw new TypeError("Unknown format option provided.");
      n = e.format;
    }
    var a = ve.formatters[n], i = R.filter;
...
// src/router/utils.ts
var ge = Xe(lr(), 1), Ue = Xe(ur(), 1), Ve = Xe(Qn(), 1);
...
var tl = /\/([^/]+)\/(?:(.*)_)?([^/]+)?/, Yn = (0, Ue.default)(1e3)((t) => {
  ...
  return (0, ge.default)(t) && (0, ge.default)(e) ? Object.keys({ ...t, ...e }).reduce((r, n) => {
    let a = Rt(t?.[n], e?.[n]);
...
t, r)) : (0, ge.default)(e) ? Object.entries(e).every(([r, n]) => Nt(r, n)) : !1, "validateArgs"), It = /* @__PURE__ */ o((t) => t === void 0 ?
"!undefined" : t === null ? "!null" : typeof t == "string" ? Xn.test(t) ? `!hex(${t.slice(1)})` : Zn.test(t) ? `!${t.replace(/[\s%]/g, "")}` :
t : typeof t == "boolean" ? `!${t}` : Array.isArray(t) ? t.map(It) : (0, ge.default)(t) ? Object.entries(t).reduce(
...
o avoid this situation."
  ...
  c == null && (c = 0, a.replaceState(le({}, a.state, {
    idx: c
  }), ""));
  function h(v) {
  ...
  o(h, "createHref");
  function m(v, E) {
    return E === void 0 && (E = null), ra(le({
      pathname: y.pathname,
      hash: "",
      search: ""
    }, typeof v == "string" ? se(v) : v, {
      state: E,
      key: il()
    }));
  }
...
import { createContext as Tt, useRef as ll, useState as iu, useLayoutEffect as lu, createElement as la, useContext as ue, useEffect as sl, useMemo as _t,
...
function ca(t, e, r) {
  let n = typeof t == "string" ? se(t) : t, a = t === "" || n.pathname === "" ? "/" : n.pathname, i;
  if (a == null)
    i = r;
  else {
    let u = e.length - 1;
...
o(ca, "resolveTo");
function fl(t) {
  return t === "" || t.pathname === "" ? "/" : typeof t == "string" ? se(t).pathname : t.pathname;
}
o(fl, "getToPathname");
function pl(t, e) {
  if (e === "/") return t;
