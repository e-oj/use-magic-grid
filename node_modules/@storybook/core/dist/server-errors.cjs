...
var we = (t, e) => () => (e || t((e = { exports: {} }).exports, e), e.exports), ve = (t, e) => {
  for (var o in e)
    A(t, o, { get: e[o], enumerable: !0 });
}, ce = (t, e, o, r) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let s of Me(e))
      !Se.call(t, s) && s !== o && A(t, s, { get: () => e[s], enumerable: !(r = _e(e, s)) || r.enumerable });
  return t;
};
var x = (t, e, o) => (o = t != null ? xe(Ie(t)) : {}, ce(
  // If the importer is in node compatibility mode or this is not an ESM
  // file that has been converted to a CommonJS file using a Babel-
  // compatible transform (i.e. "__esModule" has not been set), then set
  // "default" to the CommonJS "module.exports" for node compatibility.
  e || !t || !t.__esModule ? A(o, "default", { value: t, enumerable: !0 }) : o,
  t
)), Ne = (t) => ce(A({}, "__esModule", { value: !0 }), t);
...
var Oe = we((T) => {
  ...
  function Re(t) {
    ...
    var s = r.reduce(function(g, S) {
      var O = S.match(/\n([\t ]+|(?!\s).)/g);
      return O ? g.concat(O.map(function(w) {
        var y, b;
        return (b = (y = w.match(/[\t ]/g)) === null || y === void 0 ? void 0 : y.length) !== null && b !== void 0 ? b : 0;
      })) : g;
    }, []);
    if (s.length) {
      var a = new RegExp(`
...
var Xe = {};
ve(Xe, {
  AngularLegacyBuildOptionsError: () => Y,
  Category: () => Ce,
  ConflictingStaticDirConfigError: () => j,
  CouldNotEvaluateFrameworkError: () => P,
  CriticalPresetLoadError: () => H,
  FindPackageVersionsError: () => ae,
  GenerateNewProjectOnInitError: () => oe,
  GoogleFontsDownloadError: () => z,
  GoogleFontsLoadingError: () => J,
  InvalidFrameworkNameError: () => K,
  InvalidStoriesEntryError: () => V,
  MainFileESMOnlyImportError: () => Q,
  MainFileEvaluationError: () => ee,
  MainFileMissingError: () => Z,
  MissingAngularJsonError: () => U,
  MissingBuilderError: () => X,
  MissingFrameworkFieldError: () => F,
  NoMatchingExportError: () => q,
  NoStatsForViteDevError: () => ie,
  NxProjectDetectedError: () => W,
  UpgradeStorybookInWrongWorkingDirectory: () => se,
  UpgradeStorybookToLowerVersionError: () => te,
  UpgradeStorybookToSameVersionError: () => re,
  UpgradeStorybookUnknownCurrentVersionError: () => ne,
  WebpackCompilationError: () => G,
  WebpackInvocationError: () => D,
  WebpackMissingStatsError: () => $
});
module.exports = Ne(Xe);

// node_modules/chalk/source/vendor/ansi-styles/index.js
var le = /* @__PURE__ */ n((t = 0) => (e) => `\x1B[${e + t}m`, "wrapAnsi16"), ue = /* @__PURE__ */ n((t = 0) => (e) => `\x1B[${38 + t};5;${e}\
m`, "wrapAnsi256"), de = /* @__PURE__ */ n((t = 0) => (e, o, r) => `\x1B[${38 + t};2;${e};${o};${r}m`, "wrapAnsi16m"), u = {
  modifier: {
    reset: [0, 0],
...
}, Je = Object.keys(u.modifier), Le = Object.keys(u.color), Be = Object.keys(u.bgColor), qe = [...Le, ...Be];
function We() {
  ...
  return Object.defineProperty(u, "codes", {
    value: t,
    enumerable: !1
  }), u.color.close = "\x1B[39m", u.bgColor.close = "\x1B[49m", u.color.ansi = le(), u.color.ansi256 = ue(), u.color.ansi16m = de(), u.bgColor.
  ansi = le(10), u.bgColor.ansi256 = ue(10), u.bgColor.ansi16m = de(10), Object.defineProperties(u, {
    rgbToAnsi256: {
      value(e, o, r) {
...
var M = x(require("node:process"), 1), ge = x(require("node:os"), 1), v = x(require("node:tty"), 1);
function f(t, e = globalThis.Deno ? globalThis.Deno.args : M.default.argv) {
  let o = t.startsWith("-") ? "" : t.length === 1 ? "-" : "--", r = e.indexOf(o + t), s = e.indexOf("--");
  return r !== -1 && (s === -1 || r < s);
}
n(f, "hasFlag");
var { env: p } = M.default, _;
f("no-color") || f("no-colors") || f("color=false") || f("color=never") ? _ = 0 : (f("color") || f("colors") || f("color=true") || f("color=\
always")) && (_ = 1);
function Ke() {
  if ("FORCE_COLOR" in p)
...
n(Pe, "translateLevel");
function je(t, { streamIsTTY: e, sniffFlags: o = !0 } = {}) {
  let r = Ke();
  r !== void 0 && (_ = r);
  let s = o ? _ : r;
  if (s === 0)
  ...
  if (p.TERM === "dumb")
    return a;
  if (M.default.platform === "win32") {
    let d = ge.default.release().split(".");
...
n(pe, "createSupportsColor");
var Ve = {
  stdout: pe({ isTTY: v.default.isatty(1) }),
  stderr: pe({ isTTY: v.default.isatty(2) })
}, fe = Ve;
...
n(he, "stringEncaseCRLFWithFirstIndex");

// node_modules/chalk/source/index.js
var { stdout: ye, stderr: be } = fe, N = Symbol("GENERATOR"), E = Symbol("STYLER"), k = Symbol("IS_EMPTY"), Ee = [
  "ansi",
  "ansi",
  "ansi256",
  "ansi16m"
], R = /* @__PURE__ */ Object.create(null), $e = /* @__PURE__ */ n((t, e = {}) => {
...
var De = /* @__PURE__ */ n((t) => {
  ...
  return $e(e, t), Object.setPrototypeOf(e, C.prototype), e;
}, "chalkFactory");
function C(t) {
  return De(t);
}
n(C, "createChalk");
Object.setPrototypeOf(C.prototype, Function.prototype);
for (let [t, e] of Object.entries(h))
  R[t] = {
    get() {
      let o = I(this, B(e.open, e.close, this[E]), this[k]);
      return Object.defineProperty(this, t, { value: o }), o;
    }
  };
R.visible = {
  get() {
    let t = I(this, this[E], !0);
    return Object.defineProperty(this, "visible", { value: t }), t;
  }
};
var L = /* @__PURE__ */ n((t, e, o, ...r) => t === "rgb" ? e === "ansi16m" ? h[o].ansi16m(...r) : e === "ansi256" ? h[o].ansi256(h.rgbToAnsi256(
...r)) : h[o].ansi(h.rgbToAnsi(...r)) : t === "hex" ? L("rgb", e, o, ...h.hexToRgb(...r)) : h[o][t](...r), "getModelAnsi"), Ge = ["rgb", "he\
x", "ansi256"];
for (let t of Ge) {
  R[t] = {
    get() {
      let { level: o } = this;
      return function(...r) {
        let s = B(L(t, Ee[o], "color", ...r), h.color.close, this[E]);
        return I(this, s, this[k]);
      };
    }
  };
  ...
  R[e] = {
    get() {
      let { level: o } = this;
      return function(...r) {
        let s = B(L(t, Ee[o], "bgColor", ...r), h.bgColor.close, this[E]);
        return I(this, s, this[k]);
      };
    }
  };
...
var Ue = Object.defineProperties(() => {
...
}, "createStyler"), I = /* @__PURE__ */ n((t, e, o) => {
  let r = /* @__PURE__ */ n((...s) => Ye(r, s.length === 1 ? "" + s[0] : s.join(" ")), "builder");
  return Object.setPrototypeOf(r, Ue), r[N] = t, r[E] = e, r[k] = o, r;
}, "createBuilder"), Ye = /* @__PURE__ */ n((t, e) => {
  if (t.level <= 0 || !e)
    return t[k] ? "" : e;
  let o = t[E];
  if (o === void 0)
  ...
  if (e.includes("\x1B"))
    for (; o !== void 0; )
      e = me(e, o.close, o.open), o = o.parent;
  let a = e.indexOf(`
`);
  return a !== -1 && (e = he(e, s, r, a)), r + e + s;
}, "applyStyle");
Object.defineProperties(C.prototype, R);
var He = C(), ao = C({ level: be ? be.level : 0 });
var m = He;
...
var c = class t extends Error {
  ...
  static getFullMessage({
    ...
    let a;
    return e === !0 ? a = `https://storybook.js.org/error/${Ae({ code: o, category: r })}` : typeof e == "string" ? a = e : Array.isArray(e) &&
    (a = `
${e.map((d) => `	- ${d}`).join(`
`)}`), `${s}${a != null ? `
...
// src/server-errors.ts
var Ce = /* @__PURE__ */ ((i) => (i.CLI = "CLI", i.CLI_INIT = "CLI_INIT", i.CLI_AUTOMIGRATE = "CLI_AUTOMIGRATE", i.CLI_UPGRADE = "CLI_UPGRAD\
...
WEB-COMPONENTS-WEBPACK5", i))(Ce || {}), W = class extends c {
  static {
...
n(ke, "removeAnsiEscapeCodes");
var G = class extends c {
  constructor(o) {
    o.errors = o.errors.map((r) => ({
      ...r,
      message: ke(r.message),
      stack: ke(r.stack),
      name: r.name
    }));
    super({
